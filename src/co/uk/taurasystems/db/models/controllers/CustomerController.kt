...
object CustomerController {
    ...
    @JvmStatic fun getLatestOf(customer: Customer): Customer? {
        ...
        try {
            ...
            while (result.next()) {
                val firstname = result.getObject("firstname") as String
                val surname = result.getObject("surname") as String
                val phonenumber = result.getObject("phonenumber") as String
                ...
                if (addressFirstLine != null) customer.addressFirstLine = addressFirstLine
            }
        } catch (e: SQLException) {
            e.printStackTrace()
            return null
